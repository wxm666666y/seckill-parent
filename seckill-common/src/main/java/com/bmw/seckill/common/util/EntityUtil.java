...
public class EntityUtil {
    ...
    private final String moduleName = "bmw_seckill"; // 数据库名称

    private final String bean_path = "D:\\IDEA-Workspace\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "D:\\IDEA-Workspace\\seckill-parent\\seckill-service\\src\\main\\java\\com\\bmw\\seckill\\dao";

    private final String xml_path = "D:\\IDEA-Workspace\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径
